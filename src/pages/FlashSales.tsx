...
const FlashSalesPage = () => {
  ...
  const FlashSaleCard = ({ sale }: { sale: any }) => {
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-2xl font-bold text-green-600">
              {activeFlashSales.reduce((acc, sale) => acc + Math.round(((sale.quantitySold / sale.totalQuantityAvailable) * 100)), 0) / activeFlashSales.length || 0}%
            </div>
